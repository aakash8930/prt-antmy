...
const systemThinking: StateResolver = (viewport) => {
  ...
  return {
    ...
    nodes: [
      ...
      node("core", "Backend", "service", 610, 350, { emphasis: "primary", width: 150 }),
      node("data", "Data", "data", 840, 350),
      node("payment", "Payment", "external", 870, 115, { emphasis: "external" }),
      node("location", "Location", "external", 870, 575, { emphasis: "external" }),
    ],
    edges: [
      { id: "system-interface-api", from: "interface", to: "api", kind: "primary" },
      { id: "system-admin-api", from: "admin-surface", to: "api", kind: "branch" },
      { id: "system-api-core", from: "api", to: "core", kind: "primary" },
      { id: "system-core-payment", from: "core", to: "payment", kind: "branch" },
      { id: "system-core-location", from: "core", to: "location", kind: "branch" },
      { id: "system-core-data", from: "core", to: "data", kind: "primary" },
  ...
  return {
    ...
    nodes: items.map(([id, label], index) =>
      node(
        ...
        label,
        "outcome",
        mobile ? 195 : 250 + index * 110,
        mobile ? 105 + index * 140 : 105 + index * 80,
...
const capabilityProvenance: StateResolver = (viewport) => {
  ...
  return {
    ...
    nodes: mobile
      ...
      : [
          node("early-work", "Early web work / products", "evidence", 185, 105, { emphasis: "branch", width: 205 }),
          node("interface-capability", "Interface", "outcome", 700, 105, { emphasis: "resolved" }),
          node("bellybasket-project", "BellyBasket", "evidence", 250, 185, { emphasis: "branch" }),
          node("connected-capability", "Connected system", "outcome", 700, 185, { emphasis: "resolved", width: 185 }),
          node("duforge-work", "Duforge", "evidence", 185, 265, { emphasis: "branch" }),
          node("client-capability", "Client delivery", "outcome", 700, 265, { emphasis: "resolved", width: 170 }),
          node("cravecart-project", "CraveCart", "evidence", 250, 345, { emphasis: "branch" }),
          node("shared-capability", "Shared architecture", "outcome", 700, 345, { emphasis: "resolved", width: 205 }),
          node("genko-project", "GENKŌ", "evidence", 185, 425, { emphasis: "branch" }),
          node("product-research", "Product research", "outcome", 700, 425, { emphasis: "resolved", width: 185 }),
          node("workflow-provenance", "Development workflow / GENKŌ", "evidence", 250, 505, { emphasis: "branch", width: 230 }),
          node("ai-engineering-capability", "AI-assisted engineering", "outcome", 700, 505, { emphasis: "resolved", width: 225 }),
          node("quantx-project", "QuantX", "evidence", 185, 585, { emphasis: "branch" }),
          node("experiment-capability", "ML experimentation", "outcome", 700, 585, { emphasis: "resolved", width: 205 }),
        ],
    edges: [
